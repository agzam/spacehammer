...
** Attention!
Fennel 0.3.1 [2019-12-17] came up with some breaking changes that made `master` branch no longer functional. Until the new version with of improvements and major redesign of modal system is released, I suggest you use `develop` branch of this project. Sorry for the inconvenience. 
